...
/// Creates an empty struct with the name given as an argument to this macro. Implements the [`discreet_common::diff_eq::Variable`]
/// trait for the struct that is created.
///
/// # Usage:
/// ```
/// variable!(X);
...
#[proc_macro_attribute]
pub fn finite_diff_1d(args: TokenStream, input_item: TokenStream) -> TokenStream {
    eprintln!("ARGS: {}", args);
